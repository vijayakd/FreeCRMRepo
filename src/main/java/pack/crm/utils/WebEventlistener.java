...
public class WebEventlistener extends TestBase implements WebDriverEventListener{
	...
	public void beforeAlertAccept(WebDriver driver) {
		System.out.println("**** BEFORE ACCCEPTING ALERT *******");
	}

	public void afterAlertAccept(WebDriver driver) {
		System.out.println("**** AFTER ACCCEPTING ALERT *******");
	...
	public void beforeFindBy(By by, WebElement element, WebDriver driver) {
		System.out.println("**** BEFORE FINDING *******"+by.toString());
		
	}

	public void afterFindBy(By by, WebElement element, WebDriver driver) {
		System.out.println("**** AFTER FINDING *******"+by.toString());
	...
	public void onException(Throwable throwable, WebDriver driver) {
		System.out.println("**** EXCEPTION OCCURED IS *******"+throwable);
